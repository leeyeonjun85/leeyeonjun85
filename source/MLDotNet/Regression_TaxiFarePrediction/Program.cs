...
namespace Regression_TaxiFarePrediction
{
    ...
    {
        private static string TrainDataPath = @"D:\leeyeonjun\git\leeyeonjun85\source\MLDotNet\Regression_TaxiFarePrediction\Data\taxi-fare-train.csv";
        private static string TestDataPath = @"D:\leeyeonjun\git\leeyeonjun85\source\MLDotNet\Regression_TaxiFarePrediction\Data\taxi-fare-test.csv";
        private static string ModelPath = @"D:\leeyeonjun\git\leeyeonjun85\source\MLDotNet\Regression_TaxiFarePrediction\MLModels\TaxiFareModel.zip";
