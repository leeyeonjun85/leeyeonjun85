...
namespace BikeSharingDemand
{
    ...
    {
        private static string TrainingDataLocation = @"D:\leeyeonjun\git\leeyeonjun85\source\MLDotNet\BikeSharingDemand\Data\hour_train.csv";
        private static string TestDataLocation = @"D:\leeyeonjun\git\leeyeonjun85\source\MLDotNet\BikeSharingDemand\Data\hour_test.csv";
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var trainer in regressionLearners)
            {
                ...
                string modelPath = @"D:\leeyeonjun\git\leeyeonjun85\source\MLDotNet\BikeSharingDemand\MLModels\" + trainer.name + "Model.zip";
            ...
            foreach (var learner in regressionLearners)
            {
                ...
                string modelPath = @"D:\leeyeonjun\git\leeyeonjun85\source\MLDotNet\BikeSharingDemand\MLModels\" + learner.name + "Model.zip";
